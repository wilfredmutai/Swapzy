...
public class ImagesActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnF = findViewById(R.id.floaty);
        mBtnF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ad = new Intent(ImagesActivity.this,AdsActivity.class);
                startActivity(ad);

            }
        });

        mBtnSettings = findViewById(R.id.button5);
        mBtnSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                firebaseAuth.signOut();
                Intent set = new Intent(ImagesActivity.this,SignInActivity.class);
                startActivity(set);
                finish();
            }
        });
    ...
    public void onItemClick(int position) {
        ...
        intent.putExtra("txt", mUploads.get(position).getName());
        ...
        searchView.setOnQueryTextListener(new android.support.v7.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for (Upload upload : mUploads) {
                    String item = upload.getName().toLowerCase();
